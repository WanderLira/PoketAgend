...
import com.example.josewanderlucio.poketagend.adapter.MyAdapter;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int i = 1; i < 11; i++){
            Evento event01 = new Evento();
            event01.setTitulo("Nome 0"+i);

            eventos.add(event01);
        }

        mAdapter = new MyAdapter(this, eventos);
        rv.setAdapter(mAdapter);
    }

    public void ocPerfil(View view){
